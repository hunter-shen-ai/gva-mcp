...
type McpServerTool struct {
	...
	FuncDescription *string          `json:"funcDescription" form:"funcDescription" gorm:"comment:函数描述/工具描述;column:func_description;size:2048;"` //函数描述/工具描述// FuncType        *string          `json:"funcType" form:"funcType" gorm:"comment:函数类型/工具类型;column:func_type;size:50;"`                        //函数类型/工具类型 (e.g., MCP_AGENT, SYSTEM_BUILTIN, THIRD_PARTY)
